...
# Warning messages 
m1 = "warning!!! you can take only one more day leave for Machine Learning class"
m2 = "warning!!! you can take only one more day leave for Python class"
m3 = "warning!!! you can take only one more day leave for Data Analysis class"
	...
	for student in range(0, len(row_num)): 
		...
		# if total.no.of.leaves > threshold 
			...
			if b is 1: 
				...
				subject = "Machine Learning" # subject based on the code number 
